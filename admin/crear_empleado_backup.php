...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $u = $conn->prepare("INSERT INTO users (name, email, password, rol, activo) VALUES (?, ?, ?, 'empleado', 1)");
        if (!$u) {
...
<head>
    ...
    <title>Crear Empleado - Sistema de Gestión</title>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="puesto" placeholder="Ej: Trabajador, Supervisor, etc." 
                                       value="<?php echo isset($_POST['puesto']) ? htmlspecialchars($_POST['puesto']) : 'Trabajador'; ?>">
                            </div>
                        </div>
                    </div>
                </div>
